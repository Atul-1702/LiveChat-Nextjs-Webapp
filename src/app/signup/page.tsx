...
import SignupFormModel, { SignupModel } from "../models/signup";
...
function SignupPage() {
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm({ resolver: zodResolver(SignupFormModel) });
  ...
  function toogleShowConfirmPassword() {
    setIsShowConfirmPassword((prev) => !prev);
  }

  function onSubmitForm(data: SignupModel) {
